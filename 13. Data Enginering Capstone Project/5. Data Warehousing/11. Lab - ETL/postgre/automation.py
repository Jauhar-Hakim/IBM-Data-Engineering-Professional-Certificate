...
# Connect to MySQL
conn_mysql = mysql.connector.connect(user='root', password='L6FQgoE6oLOFFXyGcXN4TuMQ',host='172.21.5.238',database='sales')
cursor_mysql = conn_mysql.cursor()

# Connect to DB2 or PostgreSql
dsn_hostname = '127.0.0.1'
dsn_user='postgres'        # e.g. "abc12345"
dsn_pwd ='MzEwNTEtbWlraWtr'      # e.g. "7dBZ3wWt9XN6$o0J"
